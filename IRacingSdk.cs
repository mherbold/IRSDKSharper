...
{
	/// <summary>
	/// Represents the primary class for interacting with the iRacing software development kit (SDK).
	/// Provides a variety of methods for controlling and querying the iRacing simulation environment,
	/// event handling, telemetry acquisition, and system state management.
	/// </summary>
	public class IRacingSdk
	{
		...
		/// <param name="enableEventSystem"></param>
		/// ***************************************** ///
